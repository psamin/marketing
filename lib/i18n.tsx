  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        "Deadlines to file are set by your state and are often shorter than people expect — don’t wait to start.",
        "No one can promise an amount. What you may recover depends on your injuries, treatment, lost income, and who was at fault.",
        "Most injury claims settle without a trial — but if the offer isn’t fair, Wayco is ready to go to court.",
        ...
        "If someone else caused your injury, you may have a claim.",
      ],
    },
    finalCta: {
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        "Los plazos para presentar los fija su estado y suelen ser más cortos de lo que la gente cree — no espere para empezar.",
        ...
        "La mayoría de los casos se resuelven sin juicio — pero si la oferta no es justa, Wayco está lista para ir a la corte.",
        ...
        "Si otra persona causó su lesión, es posible que tenga un reclamo.",
      ],
    },
    finalCta: {
