...
const DICT = {
  en: {
    ...
    faq: {
      ...
      items: [
        { q: "How does it work?", a: "Three quick steps: answer a few questions, our team reviews your answers for free, and a lawyer from the firm follows up. If the firm takes your case, it deals with the insurance companies for you." },
        ...
        { q: "How much does it cost to hire the firm?", a: "Nothing up front. You pay a fee only if the firm wins your case — it comes out of what’s recovered for you. The review itself is always free." },
        ...
        { q: "How is compensation determined?", a: "It depends on your injuries, your treatment, lost income, and who was at fault. No one can promise a number — after your review, an attorney can walk you through your options." },
        { q: "Will I have to go to court?", a: "Usually not — most injury claims settle. But if the offer isn’t fair, the firm is ready to go to trial." },
      ],
    },
    finalCta: {
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        { q: "¿Cómo funciona?", a: "Tres pasos rápidos: responda unas preguntas, nuestro equipo revisa sus respuestas gratis y un abogado de la firma le contacta. Si la firma acepta su caso, ella trata con las aseguradoras por usted." },
        ...
        { q: "¿Cuánto cuesta contratar a la firma?", a: "Nada por adelantado. Usted paga honorarios solo si la firma gana su caso — salen de lo que se recupere para usted. La evaluación siempre es gratis." },
        ...
        { q: "¿Cómo se determina la compensación?", a: "Depende de sus lesiones, su tratamiento, ingresos perdidos y de quién tuvo la culpa. Nadie puede prometer una cantidad — después de su evaluación, un abogado puede explicarle sus opciones." },
        { q: "¿Tendré que ir a la corte?", a: "Por lo general no — la mayoría de los casos se resuelven. Pero si la oferta no es justa, la firma está lista para ir a juicio." },
      ],
    },
    finalCta: {
