  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How is compensation determined?", a: "It depends on your injuries, treatment, lost income, and who was at fault. No one can promise an amount; after your review, an attorney can discuss your options." },
    ...
    footer: {
      ...
      disclaimerTail:
        " does not obligate you to retain the firm, and the firm does not guarantee acceptance of any case. Even in a contingency (“no fee unless we win”) matter, you may still be responsible for case costs and expenses regardless of the outcome. If you are facing a deadline (statute of limitations), do not delay seeking counsel.",
      // Entity-separation disclosure (the CPOM/AKS/fee-split firewall, public).
      entityDisclosure:
        "{firm} is an independent law firm and is responsible for this advertisement; {attorney} is the attorney responsible for its content. {firm} is admitted to practice in {states}; principal law office: {office}. {tech} is a technology and administrative-services company — it is not a law firm, does not provide legal services or legal advice, does not direct legal decisions, and does not select or refer clients; it provides services to the firm for fixed, fair-market-value fees.",
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cómo se determina la compensación?", a: "Depende de sus lesiones, tratamiento, ingresos perdidos y de quién tuvo la culpa. Nadie puede prometer una cantidad; después de su evaluación, un abogado puede hablar de sus opciones." },
    ...
    footer: {
      ...
      disclaimerTail:
        " no le obliga a contratar a la firma, y la firma no garantiza la aceptación de ningún caso. Incluso en un caso por contingencia (“sin honorarios a menos que ganemos”), usted podría ser responsable de los costos y gastos del caso, independientemente del resultado. Si enfrenta un plazo (prescripción), no demore en buscar asesoría legal.",
      entityDisclosure:
        "{firm} es una firma de abogados independiente y es responsable de esta publicidad; {attorney} es el abogado responsable de su contenido. {firm} está autorizada para ejercer en {states}; oficina legal principal: {office}. {tech} es una empresa de tecnología y servicios administrativos — no es una firma de abogados, no brinda servicios ni asesoría legal, no dirige decisiones legales y no selecciona ni refiere clientes; presta servicios a la firma por honorarios fijos a valor justo de mercado.",
