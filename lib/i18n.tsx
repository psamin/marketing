  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Will I have to go to court?", a: "Usually not — most injury claims settle. But if the offer isn’t fair, we’re ready to go to trial." },
      ],
    },
    finalCta: {
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Tendré que ir a la corte?", a: "Por lo general no — la mayoría de los casos se resuelven. Pero si la oferta no es justa, estamos listos para ir a juicio." },
      ],
    },
    finalCta: {
