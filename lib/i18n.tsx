...
const DICT = {
  en: {
    ...
    faq: {
      ...
      items: [
        { q: "How does it work?", a: "Three quick steps: answer a few questions, our team reviews your answers for free, and a Wayco attorney follows up. If Wayco takes your case, we handle the insurance companies for you." },
        ...
        { q: "How much does it cost to hire Wayco?", a: "Nothing up front. You pay a fee only if Wayco wins your case — it comes out of what’s recovered for you. The review itself is always free." },
        ...
        { q: "Will I have to go to court?", a: "Usually not — most injury claims settle. But if the offer isn’t fair, Wayco is ready to go to trial." },
      ],
    },
    finalCta: {
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cuánto cuesta contratar a Wayco?", a: "Nada por adelantado. Usted paga honorarios solo si Wayco gana su caso — salen de lo que se recupere para usted. La evaluación siempre es gratis." },
        ...
        { q: "¿Tendré que ir a la corte?", a: "Por lo general no — la mayoría de los casos se resuelven. Pero si la oferta no es justa, Wayco está lista para ir a juicio." },
      ],
    },
    finalCta: {
