...
const DICT = {
  en: {
    ...
    faq: {
      ...
      items: [
        { q: "How it works", a: "Three quick steps: answer a few questions, our team reviews your answers for free, and a Wayco attorney follows up. If Wayco takes your case, we handle the insurance companies for you." },
        { q: "Is Wayco a law firm?", a: "Wayco Injury Law is the law firm, and its licensed attorneys handle your case. Wayco Inc. is the technology and support company behind it — it isn’t a law firm and doesn’t give legal advice." },
        { q: "Response time", a: "Soon. You can reach us any time — day or night — and a member of the team follows up as quickly as possible." },
        { q: "Cost", a: "Nothing up front. You pay a fee only if Wayco wins your case — it comes out of what’s recovered for you. The review itself is always free." },
        { q: "Do I have a case?", a: "If someone else caused your injury, you might. The quickest way to find out is the free review — a few minutes, no obligation." },
        { q: "Filing deadline", a: "Every state sets a deadline, and it’s often shorter than people expect. Don’t wait — start your review and an attorney can tell you the deadline for your case. (Nothing is locked in until you sign an agreement.)" },
        { q: "Compensation", a: "It depends on your injuries, your treatment, lost income, and who was at fault. No one can promise a number — after your review, an attorney can walk you through your options." },
        { q: "Going to court", a: "Usually not — most injury claims settle. But if the offer isn’t fair, Wayco is ready to go to trial." },
      ],
    },
    finalCta: {
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        { q: "Cómo funciona", a: "Tres pasos rápidos: responda unas preguntas, nuestro equipo revisa sus respuestas gratis y un abogado de Wayco le contacta. Si Wayco acepta su caso, tratamos con las aseguradoras por usted." },
        { q: "¿Wayco es una firma de abogados?", a: "Wayco Injury Law es la firma de abogados, y sus abogados con licencia manejan su caso. Wayco Inc. es la empresa de tecnología y soporte detrás — no es una firma de abogados y no da asesoría legal." },
        { q: "Tiempo de respuesta", a: "Pronto. Puede comunicarse con nosotros a cualquier hora — de día o de noche — y un miembro del equipo le responde lo antes posible." },
        { q: "Costo", a: "Nada por adelantado. Usted paga honorarios solo si Wayco gana su caso — salen de lo que se recupere para usted. La evaluación siempre es gratis." },
        { q: "¿Tengo un caso?", a: "Si otra persona causó su lesión, es posible. La forma más rápida de saberlo es la evaluación gratis — unos minutos, sin compromiso." },
        { q: "Plazo para presentar", a: "Cada estado fija un plazo, y suele ser más corto de lo que la gente cree. No espere — comience su evaluación y un abogado puede decirle el plazo de su caso. (Nada queda fijado hasta que firme un acuerdo.)" },
        { q: "Compensación", a: "Depende de sus lesiones, su tratamiento, ingresos perdidos y de quién tuvo la culpa. Nadie puede prometer una cantidad — después de su evaluación, un abogado puede explicarle sus opciones." },
        { q: "Ir a la corte", a: "Por lo general no — la mayoría de los casos se resuelven. Pero si la oferta no es justa, Wayco está lista para ir a juicio." },
      ],
    },
    finalCta: {
