  ...
  return (
    <>
      <style
        ...
        .wc-brand{display:flex;align-items:center;gap:11px;margin-bottom:26px}
        .wc-mark{width:36px;height:36px;border-radius:50%;background:#0a0a0a;display:flex;align-items:center;justify-content:center}
        .wc-mark span{width:14px;height:14px;border-radius:50%;background:#0a0a0a}
        .wc-name{font-family:'Fraunces',Georgia,serif;font-weight:400;font-size:20px;letter-spacing:-.3px}
